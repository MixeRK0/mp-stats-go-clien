...
func main() {
    ...
    d1 := time.Now() // string | Дата начала периода (optional)
    d2 := time.Now() // string | Дата окончания периода (optional)
    postRequestBody := *openapiclient.NewPostRequestBody(int32(123), int32(123), map[string]interface{}(123), []openapiclient.SortModelItem{*openapiclient.NewSortModelItem("ColId_example", "Sort_example")}) // PostRequestBody |  (optional)
