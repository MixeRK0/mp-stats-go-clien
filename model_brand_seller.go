...
func (o BrandSeller) MarshalJSON() ([]byte, error) {
...
type NullableBrandSeller struct {
	value *BrandSeller
	isSet bool
}

func (v NullableBrandSeller) Get() *BrandSeller {
	return v.value
}

func (v *NullableBrandSeller) Set(val *BrandSeller) {
	v.value = val
	v.isSet = true
}

func (v NullableBrandSeller) IsSet() bool {
	return v.isSet
}

func (v *NullableBrandSeller) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBrandSeller(val *BrandSeller) *NullableBrandSeller {
	return &NullableBrandSeller{value: val, isSet: true}
}

func (v NullableBrandSeller) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBrandSeller) UnmarshalJSON(src []byte) error {
	v.isSet = true
