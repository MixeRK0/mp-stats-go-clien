...
type CategorySubject struct {
	...
	// Комиссия FBO
	CommissionFbo *float32 `json:"commission_fbo,omitempty"`
	// Комиссия FBS
	CommissionFbs *float32 `json:"commission_fbs,omitempty"`
	// Базовая логистика
...
// GetCommissionFbo returns the CommissionFbo field value if set, zero value otherwise.
func (o *CategorySubject) GetCommissionFbo() float32 {
	if o == nil || o.CommissionFbo == nil {
		var ret float32
		return ret
	}
...
// GetCommissionFboOk returns a tuple with the CommissionFbo field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetCommissionFbo gets a reference to the given float32 and assigns it to the CommissionFbo field.
func (o *CategorySubject) SetCommissionFbo(v float32) {
	o.CommissionFbo = &v
}

// GetCommissionFbs returns the CommissionFbs field value if set, zero value otherwise.
func (o *CategorySubject) GetCommissionFbs() float32 {
	if o == nil || o.CommissionFbs == nil {
		var ret float32
		return ret
	}
...
// GetCommissionFbsOk returns a tuple with the CommissionFbs field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetCommissionFbs gets a reference to the given float32 and assigns it to the CommissionFbs field.
...
func (o CategorySubject) MarshalJSON() ([]byte, error) {
	...
	if o.CommissionFbo != nil {
		toSerialize["commission_fbo"] = o.CommissionFbo
	}
	if o.CommissionFbs != nil {
