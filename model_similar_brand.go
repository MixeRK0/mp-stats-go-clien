...
func (o SimilarBrand) MarshalJSON() ([]byte, error) {
...
type NullableSimilarBrand struct {
	value *SimilarBrand
	isSet bool
}

func (v NullableSimilarBrand) Get() *SimilarBrand {
	return v.value
}

func (v *NullableSimilarBrand) Set(val *SimilarBrand) {
	v.value = val
	v.isSet = true
}

func (v NullableSimilarBrand) IsSet() bool {
	return v.isSet
}

func (v *NullableSimilarBrand) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSimilarBrand(val *SimilarBrand) *NullableSimilarBrand {
	return &NullableSimilarBrand{value: val, isSet: true}
}

func (v NullableSimilarBrand) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSimilarBrand) UnmarshalJSON(src []byte) error {
	v.isSet = true
